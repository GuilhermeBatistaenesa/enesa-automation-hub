...
from app.api.deps import principal_has_scoped_grants, require_permission, require_run_permission
from app.core.rbac import PERMISSION_ARTIFACT_DOWNLOAD, PERMISSION_ROBOT_RUN, PERMISSION_RUN_READ
...
def get_runs(
    ...
    items, total = list_runs(db=db, robot_id=robot_id, service_id=service_id, status=status_filter, skip=skip, limit=limit)
